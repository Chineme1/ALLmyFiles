...
int main()
{
	...
	cout << "The largest value is: "<< largest << endl;
	cout<<"Hopefully this shit works\n"<<endl;
	int bo= largest;
	auto result1 = isSubsetSum1(b, bo);
	std::cout << std::get<bool>(result1) << '\n';
	auto& indices31 = std::get<1>(result);
	for(auto index : indices31) std::cout <<index <<' ';
	return 0;
